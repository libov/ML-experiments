...
mlflow.set_experiment("ResNet-CIFAR10-Classifier-Dropout")
...
for params in all_params:
    for run in range(3): # repeat each experiment 3 times
        with mlflow.start_run(run_name = f"dropout-{params['dropout_blocks']}-run{run}"):
